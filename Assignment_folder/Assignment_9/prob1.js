...
function addMatrices(A, B) {
    ...
    for (let i = 0; i < numRows; i++) {
        result.push(Array(numCols).fill(0));
    }
...
console.log(addMatrices(A1, B1)); // Output: [[10, 10, 10], [10, 10, 10], [10, 10, 10]]

const A2 = [[1, 2, 3], [4, 1, 2], [7, 8, 9]];
const B2 = [[9, 9, 7], [1, 2, 4], [4, 6, 3]];
console.log(addMatrices(A2, B2)); // Output: [[10, 11, 10], [5, 3, 6], [11, 14, 12]]
